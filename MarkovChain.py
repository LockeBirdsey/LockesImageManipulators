...
# Taken from https://gist.github.com/JonnoFTW/5b036797593c5c40aabdf2d6c1399387
# which was found https://scicomp.stackexchange.com/questions/22022/markov-chain-image-generators

class MarkovChain(object):
    def __init__(self, bucket_size=10, four_neighbour=True, display_progress=False):
...
if __name__ == "__main__":
    ...
    chain = MarkovChain(bucket_size=16, four_neighbour=False)
    try:
        fnames = sys.argv[1:]
    except IndexError:
        fnames = ['me.jpg']
